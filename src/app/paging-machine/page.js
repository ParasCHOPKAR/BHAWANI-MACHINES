...
export default function PagingMachinePage() {
  return (
    <div className="product-page">
      ...
      <section className="product-header-section bg-light" style={{ padding: '4rem 0', borderBottom: '1px solid #eaeaea' }}>
        <div className="container">
          ...
          <h1 className="section-title text-left" style={{ margin: '0', fontSize: '2.5rem' }}>Paging Machine (Friction Feeder)</h1>
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px' }}>Model CPM-300</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="product-layout">
            ...
            <div className="product-gallery">
              <div className="main-image" style={{ background: '#f9f9f9', border: '1px solid #eaeaea', borderRadius: '8px', padding: '2rem', textAlign: 'center', marginBottom: '1rem' }}>
                <div style={{ height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ccc', fontSize: '1.2rem', flexDirection: 'column' }}>
                  <i className="fas fa-layer-group" style={{ fontSize: '4rem', marginBottom: '1rem' }}></i>
                  <p>Paging Machine Image</p>
                </div>
              </div>
              ...
              <div style={{ marginTop: '2rem' }}>
                ...
                <div className="applicable-products-grid">
                  <div style={{ background: '#f9f9f9', padding: '10px', textAlign: 'center', borderRadius: '4px', border: '1px solid #eee', fontSize: '0.9rem' }}>Empty Pouches</div>
                  ...
                  <div style={{ background: '#f9f9f9', padding: '10px', textAlign: 'center', borderRadius: '4px', border: '1px solid #eee', fontSize: '0.9rem' }}>Flat Cartons</div>
                  <div style={{ background: '#f9f9f9', padding: '10px', textAlign: 'center', borderRadius: '4px', border: '1px solid #eee', fontSize: '0.9rem' }}>Cards & Labels</div>
                </div>
              </div>
            </div>
            ...
            <div className="product-info">
              <h2 style={{ fontSize: '1.8rem', color: 'var(--secondary-color)', marginBottom: '1.5rem' }}>High-Speed Automated Feeding</h2>
              <p style={{ color: 'var(--text-light)', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '2rem' }}>
                The CPM-300 Paging Machine (also known as a Friction Feeder) is designed to automatically separate stacks of flat products—such as empty pouches, cartons, paper bags, or cards—and feed them individually onto a conveyor line. It is highly essential for automating coding, marking, and labelling processes.
              </p>
              ...
              <ul className="product-feature-list" style={{ listStyle: 'none', padding: '0', marginBottom: '2.5rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span><strong>Precision Feeding:</strong> Separates stacked products into a single, continuous stream at high speeds (up to 60 meters/min) without jams or double-feeds.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Adjustable Parameters:</strong> Easily adjustable to accommodate a wide range of product sizes, with widths from 50mm up to 350mm, and lengths up to 500mm.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Automation Synergy:</strong> Perfectly integrates with inkjet printers, TIJ coders, or labelling machines to significantly reduce manual labor and improve production accuracy.</span>
                </li>
              </ul>
      ...
      <section className="section bg-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle mx-auto">Detailed specifications for our CPM-300 Paging Machine.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
              <thead>
                <tr style={{ background: 'var(--secondary-color)', color: 'white' }}>
                  ...
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem' }}>CPM-300</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>50 - 350 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Available Length of Product</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>65 - 500 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Speed</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>0 - 60 m/min</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Dimension</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>1400 x 350 x 700 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
