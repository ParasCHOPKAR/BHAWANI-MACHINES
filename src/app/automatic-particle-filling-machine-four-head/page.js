...
export default function AutomaticParticleFillingMachineFourHeadPage() {
  return (
    <div className="product-page">
      ...
      <section className="product-header-section bg-light" style={{ padding: '4rem 0', borderBottom: '1px solid #eaeaea' }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px' }}>Automatic Particle Filling Machine - Four Head (AGF-100 & AGF-1000)</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="product-layout">
            ...
            <div className="product-gallery">
              <div className="main-image" style={{ background: '#f9f9f9', border: '1px solid #eaeaea', borderRadius: '8px', padding: '2rem', textAlign: 'center', marginBottom: '1rem' }}>
                <div style={{ height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ccc', fontSize: '1.2rem', flexDirection: 'column' }}>
                  ...
                  <p>Automatic Particle Filling Machine (Four Head) Image</p>
                </div>
              </div>
            ...
            <div className="product-info">
              <h2 style={{ fontSize: '1.8rem', color: 'var(--secondary-color)', marginBottom: '1.5rem' }}>High-Speed Four Head Automated Packing</h2>
              <p style={{ color: 'var(--text-light)', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '2rem' }}>
                The Automatic Particle Filling Machine (Four Head) models, AGF-100 and AGF-1000, are designed for maximum throughput and efficiency. Featuring four independent filling heads, these pneumatic machines can achieve exceptional working speeds, making them ideal for high-volume packaging of non-sticky solid particles and powders.
              </p>
              ...
              <ul className="product-feature-list" style={{ listStyle: 'none', padding: '0', marginBottom: '2.5rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span><strong>Intelligent Control:</strong> Controlled by a Microchip Computer and assisted with High precision sensors to ensure accurate dosing across all four heads simultaneously.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Easy Format Change:</strong> Easy to use and able to switch different sizes of bag formers as per your specific packaging requirements.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Quad-Head Efficiency:</strong> The four-head configuration quadruples the filling rate, achieving up to 40 bags per minute for smaller volumes (AGF-100) and 35 bags per minute for larger volumes (AGF-1000).</span>
                </li>
              </ul>
      ...
      <section className="section bg-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle mx-auto">Detailed specifications for our Four Head Automatic Pouch Packing models.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
              <thead>
                <tr style={{ background: 'var(--secondary-color)', color: 'white' }}>
                  ...
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem', borderRight: '1px solid rgba(255,255,255,0.2)', width: '35%' }}>AGF-100</th>
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem', width: '35%' }}>AGF-1000</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Sealing Type</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>Center Sealing</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>Center Sealing</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Filling Range</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>1 - 100 g x 4</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>100 - 1000 g x 4</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Working Mode</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>Pneumatic</td>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>240 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>420 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>25 - 40 bag/min</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>25 - 35 bag/min</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Frame Type</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>Pulling Frame</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>Pulling Frame</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>80 x 97 x 183 cm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>121 x 117 x 249 cm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>185 Kg</td>
                </tr>
              </tbody>
            </table>
          </div>
