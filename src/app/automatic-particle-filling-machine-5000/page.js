...
export default function AutomaticParticleFillingMachine5000Page() {
  return (
    <div className="product-page">
      ...
      <section className="product-header-section bg-light" style={{ padding: '4rem 0', borderBottom: '1px solid #eaeaea' }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px' }}>Automatic Particle Filling Machine 5000 (AGS-5000P Series)</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="product-layout">
            ...
            <div className="product-gallery">
              <div className="main-image" style={{ background: '#f9f9f9', border: '1px solid #eaeaea', borderRadius: '8px', padding: '2rem', textAlign: 'center', marginBottom: '1rem' }}>
                <div style={{ height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ccc', fontSize: '1.2rem', flexDirection: 'column' }}>
                  ...
                  <p>Automatic Particle Filling Machine 5000 Image</p>
                </div>
              </div>
            ...
            <div className="product-info">
              <h2 style={{ fontSize: '1.8rem', color: 'var(--secondary-color)', marginBottom: '1.5rem' }}>Ultra High-Capacity Automated Pouch Packing</h2>
              <p style={{ color: 'var(--text-light)', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '2rem' }}>
                The Automatic Particle Filling Machine 5000 (AGS-5000P) is our largest capacity automated packaging solution, handling massive filling volumes up to 5000g. Featuring a pneumatic pulling frame and integrated conveyor compatibility, it's designed for industrial-scale packaging of non-sticky solid particles and powders.
              </p>
              ...
              <ul className="product-feature-list" style={{ listStyle: 'none', padding: '0', marginBottom: '2.5rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span><strong>Intelligent Control:</strong> Controlled by a microchip computer and assisted with a high-precision sensor for exact dosing even at high volumes.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Easy Format Change:</strong> Designed to be user-friendly, allowing quick changes of different bag formers according to your bulk packaging requirements.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Pneumatic Power:</strong> Robust pneumatic working mode provides the necessary force and reliability for large 5kg bulk center-seal pouches.</span>
                </li>
              </ul>
      ...
      <section className="section bg-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle mx-auto">Detailed specifications for our AGS-5000P Automatic Pouch Packing model.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
              <thead>
                <tr style={{ background: 'var(--secondary-color)', color: 'white' }}>
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem', borderRight: '1px solid rgba(255,255,255,0.2)', width: '40%' }}>MODEL</th>
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem' }}>AGS-5000P</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>100 - 5000 g</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Film Width (Max)</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>550 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>5 - 12 bag/min (Depends upon Product)</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>70 x 120 x 200 cm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Machine Weight</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>155 Kg</td>
                </tr>
              </tbody>
            </table>
          </div>
