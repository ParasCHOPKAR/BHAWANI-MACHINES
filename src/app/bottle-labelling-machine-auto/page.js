...
export default function AutomaticBottleLabellingMachinePage() {
  return (
    <div className="product-page">
      ...
      <section className="product-header-section bg-light" style={{ padding: '4rem 0', borderBottom: '1px solid #eaeaea' }}>
        <div className="container">
          ...
          <h1 className="section-title text-left" style={{ margin: '0', fontSize: '2.5rem' }}>Automatic Labelling Machine</h1>
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px' }}>Models LT-150, LT-150 N, and LT160</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="product-layout">
            ...
            <div className="product-gallery">
              <div className="main-image" style={{ background: '#f9f9f9', border: '1px solid #eaeaea', borderRadius: '8px', padding: '2rem', textAlign: 'center', marginBottom: '1rem' }}>
                <div style={{ height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ccc', fontSize: '1.2rem', flexDirection: 'column' }}>
                  ...
                  <p>Automatic Labelling Machine Image</p>
                </div>
              </div>
            ...
            <div className="product-info">
              <h2 style={{ fontSize: '1.8rem', color: 'var(--secondary-color)', marginBottom: '1.5rem' }}>High-Speed Automatic Labelling Line</h2>
              <p style={{ color: 'var(--text-light)', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '2rem' }}>
                Designed to integrate directly into your high-speed production line, our Automatic Labelling Machines feature built-in conveyors and advanced microchip control. These heavy-duty models deliver consistent, flawless label application on round (LT-150 series) and flat (LT-160) containers without the need for manual feeding.
              </p>
              ...
              <ul className="product-feature-list" style={{ listStyle: 'none', padding: '0', marginBottom: '2.5rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span><strong>Advanced Control:</strong> Fully controlled by a microchip computer and assisted with high precision sensors for unmatched accuracy (± 1mm) at high speeds.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>User-Friendly Interface:</strong> Easy to use digital interface makes it extremely simple to switch between different label and bottle sizes as per your exact requirements.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span><strong>Versatile Integration:</strong> Perfect for a wide range of round or flat containers. The machines are built on a robust 130kg frame featuring a built-in conveyor system for seamless automation.</span>
                </li>
              </ul>
      ...
      <section className="section bg-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle mx-auto">Detailed specifications for our LT-150, LT-150 N, and LT160 automatic models.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
              <thead>
                <tr style={{ background: 'var(--secondary-color)', color: 'white' }}>
                  ...
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem', borderRight: '1px solid rgba(255,255,255,0.2)' }}>LT-150</th>
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem', borderRight: '1px solid rgba(255,255,255,0.2)' }}>LT-150 N</th>
                  <th style={{ padding: '1.2rem 1.5rem', borderBottom: '2px solid #eaeaea', fontSize: '1.1rem' }}>LT160</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>400 W</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>300 W</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>240 W</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>0.4 - 0.6</td>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>25 - 50 pcs/min</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>25 - 50 pcs/min</td>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>150 x 180 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>150 x 180 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>150 x 180 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  <td style={{ padding: '1rem 1.5rem', fontWeight: '600', color: 'var(--secondary-color)', borderRight: '1px solid #eaeaea' }}>Suitable Size</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>40 - 100 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>40 - 100 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>40 - 100 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>75 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>75 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>75 mm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>250 mm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>250 mm</td>
                ...
                <tr style={{ borderBottom: '1px solid #eaeaea', background: '#fafafa' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>130 x 80 x 80 cm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>130 x 80 x 80 cm</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>130 x 80 x 100 cm</td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eaeaea' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)', borderRight: '1px solid #eaeaea' }}>130 Kg</td>
                  <td style={{ padding: '1rem 1.5rem', color: 'var(--text-light)' }}>130 Kg</td>
                </tr>
              </tbody>
            </table>
          </div>
