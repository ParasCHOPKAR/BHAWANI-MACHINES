      ...
      <section className="product-header-section bg-light" style={{ padding: '4rem 0', borderBottom: '1px solid #eaeaea' }}>
        <div className="container">
          <div className="breadcrumbs" style={{ fontSize: '0.9rem', color: '#666', marginBottom: '1rem' }}>
            <Link href="/">Home</Link> &gt; <Link href="#">Wrapping & Strapping</Link> &gt; <span style={{ color: 'var(--primary-color)', fontWeight: '600' }}>Case Erector</span>
          </div>
          <h1 className="section-title text-left" style={{ margin: '0', fontSize: '2.5rem' }}>Case Erector</h1>
        ...
        <div className="container">
          <div className="product-layout">
            ...
            <div className="product-info">
              ...
              <h2 style={{ fontSize: '1.8rem', color: 'var(--secondary-color)', marginBottom: '1.5rem' }}>Reliable Case Erecting Automation</h2>
              ...
              <ul className="product-feature-list" style={{ listStyle: 'none', padding: '0', marginBottom: '2.5rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ color: 'var(--text-light)', lineHeight: '1.5' }}>High-speed unpacking machine adopts mechanical transmission.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span style={{ color: 'var(--text-light)', lineHeight: '1.5' }}>Automatic alarm with stack light reminds to replenish the carton and lack of tape.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span style={{ color: 'var(--text-light)', lineHeight: '1.5' }}>12 case/min operation for medium speed packing line.</span>
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <i className="fas fa-check-circle" style={{ color: 'var(--primary-color)', marginTop: '4px' }}></i>
                  <span style={{ color: 'var(--text-light)', lineHeight: '1.5' }}>Safety interlocked guarding restricts access to moving parts.</span>
                </li>
              </ul>
      ...
      <section className="section bg-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle mx-auto">Detailed specifications for our CF-20TX Case Erector.</p>
          </div>
